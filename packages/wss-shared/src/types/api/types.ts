...
export type IncrementalGetUpToDate = z.infer<
  typeof schemaIncrementalGetUpToDate
>;
export type IncrementalGetOutOfSync = z.infer<
  typeof schemaIncrementalGetOutOfSync
>;
export type IncrementalGetResponse = z.infer<
  typeof schemaIncrementalGetResponse
>;

// INCREMENTAL POST
export type IncrementalPostRequest = z.infer<
  typeof schemaIncrementalPostRequest
>;
export type IncrementalPostUpdated = z.infer<
  typeof schemaIncrementalPostUpdated
>;
export type IncrementalPostOutOfSync = z.infer<
  typeof schemaIncrementalPostOutOfSync
>;
export type IncrementalPostResponse = z.infer<
  typeof schemaIncrementalPostResponse
>;
